					...
					<div class="panel-body" >
									<table class="table table-hover">
										    ...
										    <tbody>
										       ...
										       <td><a title="Cerrar appointment." id="edit" href="{{route('Appointments.edit', $appointment->id)}}" class="btn btn-sm btn-secundary"><i class="fa fa-edit"></i></a></td>
											   <td><a title="Ver appointment." href="{{route('Appointments.show', $appointment->id)}}" class="btn btn-sm btn-primary"><i class="fa fa-eye" aria-hidden="true"></i></a></td>
											   ...
											   <button title="Eliminar appointment." class="btn btn-sm btn-danger"><i class="fa fa-trash-o" aria-hidden="true"></i></button>	
											   </form>
											   </td>
										       </tr>
										       @endforeach
